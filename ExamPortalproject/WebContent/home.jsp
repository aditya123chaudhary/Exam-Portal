...
<body>
	...
	<div class="content-wrapper">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<h4 class="page-head-line">Exam Dashboard</h4>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<div class="alert alert-success">This is exam page click the
						icon to start the test !!</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-3 col-sm-3 col-xs-6">
					<a href="fetchQuestions.jsp"
						...
						<div class="dashboard-div-wrapper bk-clr-two">
							...
							<h5>To Start test click here</h5>
						</div>
					</a>
				</div>
			</div>
